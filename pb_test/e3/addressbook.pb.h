...
class SelfDescribingMessage : public ::google::protobuf::Message {
 public:
  ...
  SelfDescribingMessage* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  ...
  inline bool has_proto_files() const;
  inline void clear_proto_files();
  static const int kProtoFilesFieldNumber = 1;
  inline const ::std::string& proto_files() const;
  inline void set_proto_files(const ::std::string& value);
  inline void set_proto_files(const char* value);
  inline void set_proto_files(const char* value, size_t size);
  inline ::std::string* mutable_proto_files();
  inline ::std::string* release_proto_files();
  ...
  // @@protoc_insertion_point(class_scope:tutorial.SelfDescribingMessage)
 private:
  inline void set_has_proto_files();
  inline void clear_has_proto_files();
  ...
  void InitAsDefaultInstance();
  static SelfDescribingMessage* default_instance_;
};
// ===================================================================
...
// required string proto_files = 1;
inline bool SelfDescribingMessage::has_proto_files() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void SelfDescribingMessage::set_has_proto_files() {
  _has_bits_[0] |= 0x00000001u;
}
inline void SelfDescribingMessage::clear_has_proto_files() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void SelfDescribingMessage::clear_proto_files() {
  if (proto_files_ != &::google::protobuf::internal::kEmptyString) {
    proto_files_->clear();
  }
  clear_has_proto_files();
}
inline const ::std::string& SelfDescribingMessage::proto_files() const {
  return *proto_files_;
}
inline void SelfDescribingMessage::set_proto_files(const ::std::string& value) {
  set_has_proto_files();
  if (proto_files_ == &::google::protobuf::internal::kEmptyString) {
    proto_files_ = new ::std::string;
  }
  proto_files_->assign(value);
}
inline void SelfDescribingMessage::set_proto_files(const char* value) {
  set_has_proto_files();
  if (proto_files_ == &::google::protobuf::internal::kEmptyString) {
    proto_files_ = new ::std::string;
  }
...
inline void SelfDescribingMessage::set_proto_files(const char* value, size_t size) {
  set_has_proto_files();
  if (proto_files_ == &::google::protobuf::internal::kEmptyString) {
    proto_files_ = new ::std::string;
  }
  proto_files_->assign(reinterpret_cast<const char*>(value), size);
}
inline ::std::string* SelfDescribingMessage::mutable_proto_files() {
  set_has_proto_files();
  if (proto_files_ == &::google::protobuf::internal::kEmptyString) {
    proto_files_ = new ::std::string;
  }
...
inline ::std::string* SelfDescribingMessage::release_proto_files() {
  clear_has_proto_files();
  if (proto_files_ == &::google::protobuf::internal::kEmptyString) {
    return NULL;
  } else {
    ::std::string* temp = proto_files_;
...
inline void SelfDescribingMessage::set_type_name(const char* value, size_t size) {
  set_has_type_name();
  if (type_name_ == &::google::protobuf::internal::kEmptyString) {
    type_name_ = new ::std::string;
  }
